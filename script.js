//api.openweathermap.org/data/2.5/forecast?q={city name},{state code}&appid={API key}  5 day forecast api
//0e7370badb905409ff2800bdda54a19
...
$(document).ready(function () {
    ...
    function updateTime() {
      var realTime = moment().format("MMMM Do YYYY");
    ...
    function pastCity() {
      ...
      for (i = 0; i < cityList.length; i++) {
        ...
        cityHistory.addClass(
          "list-group-item list-group-item-action list-group-item city"
        );
    ...
    async function displayWeather() {
      var queryURL =
        ...
        cityname +
        "&units=imperial&appid=0e7370badb905409ff2800bdda54a19c";
      ...
      var currentWeatherDiv = $(
        "<div class='card-body bg-light mb-3 text-black pt-0' id='currentWeather'>"
      );
      var currentHeader = $(
      ...
      var uvURL =
        "https://api.openweathermap.org/data/2.5/uvi?appid=0e7370badb905409ff2800bdda54a19c&lat=" +
        getLat +
        "&lon=" +
        getLong;
    ...
    async function displayFiveDayForecast() {
      ...
      var forecastBox = $(
        "<div class = 'text-black' id='fiveDayForecast'>"
      );
      var forecastHeader = $(
      ...
      for (i = 0; i < 5; i++) {
        ...
        var cardBody = $("<div class='card-body bg-primary text-white'>");
        var date = new Date();
        var val =
          date.getMonth() +
          1 +
